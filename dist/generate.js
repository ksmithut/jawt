import { generateHS, generatePS, generateRS, generateES, UnsupportedAlgorithm } from './lib/jwa.js';
...
async function generate(alg, options) {
    return generateCryptoKey(alg, options).then(cryptoKey => createKeyFromCryptoKey(cryptoKey, { alg }));
}
export { generate };
